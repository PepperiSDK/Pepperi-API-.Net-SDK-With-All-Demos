...
namespace Pepperi.SDK
{
    public class ApiClient
    {
            ...
            string papiBaseUri = null, string ipaasBaseUrl = null)
        {
            ...
            this.Journeys = new JourneysEndpoint(AuthentificationManager, Logger, papiBaseUri: papiBaseUri, ipaasBaseUrl: ipaasBaseUrl);
            ...
            this.RelatedItems = new RelatedItemsEndpoint(AuthentificationManager, Logger, papiBaseUri: papiBaseUri, ipaasBaseUrl: ipaasBaseUrl);
        ...
        public JourneysEndpoint Journeys { get; private set; }
        public NotificationsEndpoint Notifications { get; private set; }
        public RelatedItemsEndpoint RelatedItems { get; private set; }
